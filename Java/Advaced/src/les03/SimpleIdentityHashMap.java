...
public class SimpleIdentityHashMap {
    public static void main(String[] args) {
        ...
        identityHashMap.put(new Integer(1),"one");//добавление значение - Классы обертки
        ...
        for (Object o : set) {
            ...
            // можно сделать вот так -Map.Entry<Integer,String> map=(Map.Entry<Integer,String>)o;
        ...
        hashMap.put(new Integer(1),"one");//добавление значение - Классы обертки
